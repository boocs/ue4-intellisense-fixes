...
async function fixNoDefines(project) {
    var _a;
    ...
    if (!mainFirstConfiguration || ((_a = mainFirstConfiguration.defines) === null || _a === void 0 ? void 0 : _a.length)) {
    ...
    const forcedIncludePaths = mainSettingsConfig.get(consts.CONFIG_SETTING_DEFAULT_FORCED_INCLUDE);
...
async function addDefinesToForcedInclude(mainWorkspace, cppSettings, forcedIncludePaths) {
    const definesUris = await findDefintionUris(mainWorkspace);
...
async function findDefintionUris(mainWorkspace) {
