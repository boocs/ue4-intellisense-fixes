...
exports.CCppPropertiesObject = void 0;
const shared = require("./shared");
const consts = require("./consts");
const console = require("./console");
class CCppPropertiesObject {
     ...
     */
    async writeIfNotEqual(cCppProperties) {
        var _a;
        if (!cCppProperties) {
        ...
        if (!this.cCppPropertiesPath) {
            console.log(`There is no ${(_a = this.workspace) === null || _a === void 0 ? void 0 : _a.name} cCppPropertiesPath!`);
            return;
        }
...
exports.CCppPropertiesObject = CCppPropertiesObject;
//# sourceMappingURL=cCppPropObject%20copy.js.map